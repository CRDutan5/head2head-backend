...
CREATE TABLE team (
    ...
    goalie INTEGER DEFAULT NULL,
    defender_one INTEGER DEFAULT NULL,
    defender_two INTEGER DEFAULT NULL,
    midfielder_one INTEGER DEFAULT NULL,
    midfielder_two INTEGER DEFAULT NULL,
